...
class Status extends Sprite {
  ...
  update(time) {
    ...
    this.game.scene.active.timer -= time - this.start

    this.heart.text = this.game.scene.vars.heart
    this.score.text = this.game.scene.vars.score
    this.timer.text = this.format(this.game.scene.active.timer)
